...
DEFAULT_SAVEDMODEL_NAME = 'RandomForestModel.pkl'
DEFAULT_PERCEPTRON_MODEL = 'PerceptronModel.joblib'
DEFAULT_KNN_MODEL = 'knn_model.pkl'
DEFAULT_NAIVEBAYES_MODEL = 'naive_bayes_model.pkl'
DEFAULT_ENCODER_PATH = DEFAULT_PARENT_DIR+'SavedModelandEncoders\\'
DEFAULT_ENCODER_FORPER = 'PerceptronModelEncoder.pkl'
DEFAULT_ENCODER_FORREST = 'le_disease.pkl'
